#!/usr/bin/env python3
"""
Скрипт для изменения бокового меню на верхнее горизонтальное меню
"""
...
def create_wiki_nav(filename):
    """Создает верхнее горизонтальное меню вики"""
  ...
  <div class="wiki-container">
   <nav class="wiki-nav">
    <div class="wiki-nav-section">
     <h3 class="wiki-nav-title">
      <i class="fas fa-book"></i> Справочники
     </h3>
     <div class="wiki-nav-links">
      <a href="index.html" class="wiki-nav-link{' active' if active_text == 'Мангистау 2024' else ''}">Мангистау 2024</a>
      <a href="about.html" class="wiki-nav-link{' active' if active_text == 'О книге' else ''}">О книге</a>
      <a href="adaptation.html" class="wiki-nav-link{' active' if active_text == 'Адаптация' else ''}">Адаптация</a>
      <a href="iucn-status.html" class="wiki-nav-link{' active' if active_text == 'IUCN статусы' else ''}">IUCN статусы</a>
      <a href="resources.html" class="wiki-nav-link{' active' if active_text == 'Полезные ресурсы' else ''}">Полезные ресурсы</a>
      <a href="glossary.html" class="wiki-nav-link{' active' if active_text == 'Словарь терминов' else ''}">Словарь терминов</a>
     </div>
    </div>
    ...
    <div class="wiki-nav-section">
     ...
     <div class="wiki-nav-links">
      <a href="ustyurt.html" class="wiki-nav-link{' active' if active_text == 'Устюрт' else ''}">Устюрт</a>
      <a href="bozzhyra.html" class="wiki-nav-link{' active' if active_text == 'Бозжыра' else ''}">Бозжыра</a>
      <a href="zhygylgan.html" class="wiki-nav-link{' active' if active_text == 'Жыгылган' else ''}">Жыгылган</a>
      <a href="kyzylkup.html" class="wiki-nav-link{' active' if active_text == 'Кызылкуп' else ''}">Кызылкуп</a>
      <a href="kapamsai.html" class="wiki-nav-link{' active' if active_text == 'Капамсай' else ''}">Капамсай</a>
      <a href="tuyesu.html" class="wiki-nav-link{' active' if active_text == 'Туйесу' else ''}">Туйесу</a>
      <a href="karagie.html" class="wiki-nav-link{' active' if active_text == 'Карагие' else ''}">Карагие</a>
      <a href="torysh.html" class="wiki-nav-link{' active' if active_text == 'Торыш' else ''}">Торыш</a>
     </div>
    </div>
    ...
    <div class="wiki-nav-section">
     ...
     <div class="wiki-nav-links">
      <a href="species-guide.html" class="wiki-nav-link{' active' if active_text == 'Путеводитель' else ''}">Путеводитель</a>
      <a href="testudo-horsfieldii.html" class="wiki-nav-link{' active' if active_text == 'Черепаха' else ''}">Черепаха</a>
      <a href="tenuidactylus-caspius.html" class="wiki-nav-link{' active' if active_text == 'Геккон' else ''}">Геккон</a>
      <a href="neophron-percnopterus.html" class="wiki-nav-link{' active' if active_text == 'Стервятник' else ''}">Стервятник</a>
      <a href="bufotes-viridis.html" class="wiki-nav-link{' active' if active_text == 'Жаба' else ''}">Жаба</a>
      <a href="alectoris-chukar.html" class="wiki-nav-link{' active' if active_text == 'Кеклик' else ''}">Кеклик</a>
      <a href="solifugae-spp.html" class="wiki-nav-link{' active' if active_text == 'Солыпуга' else ''}">Солыпуга</a>
      <a href="phrynocephalus-mystaceus.html" class="wiki-nav-link{' active' if active_text == 'Круглоголовка' else ''}">Круглоголовка</a>
      <a href="trapelus-sanguinolentus.html" class="wiki-nav-link{' active' if active_text == 'Арама' else ''}">Арама</a>
      <a href="natrix-natrix.html" class="wiki-nav-link{' active' if active_text == 'Уж' else ''}">Уж</a>
     </div>
    </div>
    ...
    <div class="wiki-nav-section">
     ...
     <div class="wiki-nav-links">
      <a href="crinoidea-fossilis.html" class="wiki-nav-link{' active' if active_text == 'Морские лилии' else ''}">Морские лилии</a>
      <a href="echinoidea-fossilis.html" class="wiki-nav-link{' active' if active_text == 'Морские ежи' else ''}">Морские ежи</a>
      <a href="elasmobranchii-fossilis.html" class="wiki-nav-link{' active' if active_text == 'Зубы акул' else ''}">Зубы акул</a>
     </div>
    </div>
   </nav>
...
def main():
    """Главная функция"""
    print("Изменение бокового меню на верхнее горизонтальное...")
    print("=" * 50)
    ...
    print("[ГОТОВО] Все страницы обновлены с верхним меню!")
